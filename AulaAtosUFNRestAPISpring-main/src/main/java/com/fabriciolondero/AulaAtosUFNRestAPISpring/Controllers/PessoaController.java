...
public class PessoaController 
{
	...
	@ApiOperation(value = "Adicionar", response = Iterable.class, tags = "adicionar")
	@PostMapping
	...
	@ApiOperation(value = "Get Pessoa", response = Iterable.class, tags = "getPessoa")
	@GetMapping("/{id}")
	...
	@ApiOperation(value = "Deleta", response = Iterable.class, tags = "deletePessoa")
	@DeleteMapping("/{id}")
	...
	@ApiOperation(value = "Update", response = Iterable.class, tags = "updatePessoa")
	@PutMapping("/{id}")
